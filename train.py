        ...
        for episode in range(total_episodes):
            ...
            while step < max_steps:
                ...
                if done:
                    ...
                    next_state = np.zeros((1,frame_size[0],frame_size[1]), dtype=np.int)
                    next_state, stacked_frames = stack_frames(stacked_frames, next_state, False)
                ...
                _, loss, absolute_errors, q = sess.run([DQNetwork.optimizer, DQNetwork.loss, DQNetwork.absolute_errors, DQNetwork.Q],
                ...
                #print(f"Loss:{loss} | ISWeights {ISWeights_mb[:3]}")
